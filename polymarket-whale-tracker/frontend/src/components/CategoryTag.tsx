...
// English Premier League + Championship Teams - Current season
const EPL_TEAMS = /\b(premier league|epl|championship|efl|arsenal|gunners|aston villa|villans|bournemouth|cherries|brentford|bees|brighton|seagulls|chelsea|blues|crystal palace|palace|everton|toffees|fulham|cottagers|ipswich|leeds|leeds united|liverpool|reds|manchester city|man city|city|manchester united|man utd|man united|newcastle|magpies|nottingham forest|forest|southampton|saints|tottenham|spurs|west ham|hammers|wolves|wolverhampton|burnley|clarets|sheffield united|blades|sheffield|luton|hatters|leicester|foxes|sunderland|blackburn rovers|blackburn|middlesbrough|boro|stoke city|stoke|west brom|west bromwich|albion|swansea|swansea city|hull city|hull|norwich|canaries|cardiff|cardiff city|watford|hornets|millwall|qpr|queens park rangers|coventry|coventry city|bristol city|preston|preston north end|plymouth|plymouth argyle|derby|derby county|birmingham|birmingham city|reading|portsmouth|pompey|wigan|bolton|wanderers|charlton|barnsley)\b/i;
